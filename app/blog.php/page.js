...
export const metadata = buildMetadata({
  title: 'Electrical & Generator Articles for York County Homeowners',
  description:
    'Expert articles from GBR Electrical Services, LLC — licensed electrician and Kohler generator dealer in Dover, PA. Tips on generators, outage prep, and electrical safety for York County families.',
  path: '/blog.php',
});
...
const ARTICLES = [
  {
    ...
    excerpt:
      'Federal Pacific or Zinsco panel? Knob-and-tube wiring? GBR Electrical explains the warning signs of an outdated panel, why insurers flag certain brands, and what an upgrade involves.',
    read: '8 min read',
  ...
  },
  {
    ...
    excerpt:
      'Thinking about a home EV charger? GBR Electrical explains what a Level 2 charger install involves, how to know if your panel has capacity, and what permits Pennsylvania requires.',
    read: '7 min read',
  ...
  },
  {
    ...
    excerpt:
      'Looking for an authorized Kohler generator dealer in PA? GBR Electrical (Dealer #1506430) explains what authorized dealer status means and how to verify it before you hire anyone.',
    read: '7 min read',
  ...
  return (
    <>
      ...
      {/* ================================================================
          PAGE HERO
          ================================================================ */}
      <section className="relative bg-navy overflow-hidden dot-grid py-20 md:py-24" aria-label="Articles page hero">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-heading text-power-red text-sm tracking-widest uppercase">Expert Electrical Advice</span>
          </div>
          <h1 className="font-heading text-white text-5xl sm:text-6xl uppercase tracking-tight mb-4">
            Generator &amp; Electrical <span className="text-power-red">Articles</span>
          </h1>
      ...
      <section className="bg-white py-16" aria-labelledby="articles-heading">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {ARTICLES.map((a) => (
              <article key={a.href} className="bg-silver-lt border border-gray-200 rounded-xl overflow-hidden card-lift flex flex-col">

                {/* Card top accent + icon */}
                <div className="bg-navy p-8 flex items-center justify-between">
                  <div className="w-14 h-14 bg-power-red/20 flex items-center justify-center rounded-xl">
                    <i className={`${a.icon} text-power-red text-2xl`} aria-hidden="true"></i>
                  </div>
                  <span className="font-heading text-power-red text-xs tracking-widest uppercase">{a.cat}</span>
                </div>

                {/* Content */}
                <div className="p-7 flex flex-col flex-1">
                  <div className="flex items-center gap-3 text-steel-dark text-xs mb-4">
                    <span><i className="fas fa-calendar text-power-red mr-1" aria-hidden="true"></i>{a.date}</span>
                    <span className="opacity-40">|</span>
                    <span><i className="fas fa-clock text-power-red mr-1" aria-hidden="true"></i>{a.read}</span>
                  </div>

                  <h2 className="font-heading text-navy text-xl uppercase tracking-wide leading-snug mb-4">
                    {a.h1}
                  </h2>

                  <p className="text-steel-dark text-sm leading-relaxed mb-6 flex-1">
                    {a.excerpt}
                  </p>

                  <a
                    href={a.href}
                    className="inline-flex items-center gap-2 font-heading text-sm text-power-red-dk tracking-wider uppercase
                           hover:gap-3 transition-all duration-200 cursor-pointer"
                  >
                    Read Article <i className="fas fa-arrow-right text-xs" aria-hidden="true"></i>
                  </a>
                </div>
      ...
      {/* ================================================================
          BOTTOM CTA
          ================================================================ */}
      <section className="bg-navy py-14 dot-grid" aria-label="Contact CTA">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="font-heading text-power-red text-sm tracking-widest uppercase mb-3">Ready to Talk?</p>
          ...
          <p className="text-silver/80 mb-8 max-w-xl mx-auto">
            GBR Electrical Services, LLC — 5605 Fish and Game Road, Dover, PA 17315
            <br />
            <a href="tel:7174671712" className="text-power-red hover:text-red-400 transition-colors">717-467-1712</a>
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/contact.php" className="btn-red"><i className="fas fa-paper-plane" aria-hidden="true"></i> Contact Us</a>
            <a href="tel:7174671712" className="btn-outline-white"><i className="fas fa-phone" aria-hidden="true"></i> 717-467-1712</a>
          </div>
        </div>
      </section>
    </>
